...
<clay:container-fluid>
	<clay:sheet>
		...
		<portlet:renderURL var="addCourseURL">
            ...
            <liferay-ui:search-container total="<%= coursesAPI.getDifferentUserCoursesCount(themeDisplay.getUserId()) %>" emptyResultsMessage="Nessun corso trovato">
            				<liferay-ui:search-container-results results="<%= coursesAPI.getDifferentUserCourses(themeDisplay.getUserId())  %>"/>
